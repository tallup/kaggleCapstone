...
export default function ViewVitals() {
    ...
    const { data: vitalsData, isLoading } = useQuery({
        queryKey: ['vitals-view', residentId, year, month, currentPage, perPage],
        queryFn: async () => {
            const params = {
                per_page: perPage,
                page: currentPage,
        ...
        enabled: !!residentId, // Only fetch when resident is selected
    });
    ...
    return (
        <div className="min-h-screen bg-gray-900 text-white">
            ...
            <div className="bg-gray-800 border-b border-gray-700 px-6 py-4">
                <h1 className="text-3xl font-bold text-blue-400">Resident Vitals</h1>
            </div>
            ...
            <div className="p-6">
                ...
                <div className="bg-gray-800 rounded-lg p-4 mb-6">
                    <div className="flex flex-wrap items-center gap-4">
                        <div className="flex-1 min-w-[200px]">
                            ...
                            <div className="relative">
                                ...
                                <select
                                    ...
                                    className="w-full pl-9 pr-3 py-2 bg-gray-700 border border-gray-600 rounded-lg text-white focus:ring-2 focus:ring-blue-500 focus:border-transparent appearance-none"
                                >
                        ...
                        <div>
                            <button className="px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors mt-6">
                                Allow
                            </button>
                        </div>
                    ...
                    <>
                        ...
                        <div className="flex justify-center gap-4 mb-6">
                            ...
                            <button
                                ...
                                className="px-6 py-2 bg-white text-blue-600 border-2 border-blue-600 rounded-lg hover:bg-gray-50 transition-colors flex items-center gap-2"
                            >
                            ...
                            <div className="overflow-x-auto">
                                <table className="w-full">
                                    <thead className="bg-gray-700">
                                        <tr>
                                            <th className="px-6 py-3 text-left text-xs font-medium text-blue-400 uppercase tracking-wider">Date</th>
                                            <th className="px-6 py-3 text-left text-xs font-medium text-blue-400 uppercase tracking-wider">Blood Pressure</th>
                                            <th className="px-6 py-3 text-left text-xs font-medium text-blue-400 uppercase tracking-wider">Temperature</th>
                                            <th className="px-6 py-3 text-left text-xs font-medium text-blue-400 uppercase tracking-wider">Pulse</th>
                                            <th className="px-6 py-3 text-left text-xs font-medium text-blue-400 uppercase tracking-wider">Oxygen Saturation</th>
                                            <th className="px-6 py-3 text-left text-xs font-medium text-blue-400 uppercase tracking-wider">Pain</th>
                                            <th className="px-6 py-3 text-left text-xs font-medium text-blue-400 uppercase tracking-wider">Reason Declined</th>
                                            <th className="px-6 py-3 text-left text-xs font-medium text-blue-400 uppercase tracking-wider">Vital Status</th>
                                            <th className="px-6 py-3 text-left text-xs font-medium text-blue-400 uppercase tracking-wider">Action</th>
                                        </tr>
                                    </thead>
                ...
                {!residentId && (
                    <div className="bg-gray-800 rounded-lg shadow-lg p-12 text-center">
                        <p className="text-gray-400 text-lg">Please select a resident to view vitals data</p>
                    </div>
                )}
            </div>
        </div>
